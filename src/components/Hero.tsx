    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
          ...
          */}
          <div 
            className="w-10 h-10 md:w-36 md:h-36 bg-black rounded-full shadow-2xl bg-center bg-no-repeat bg-[length:65%]"
            style={{ backgroundImage: "url('images/logo.png')" }}
          >
            {/* Empty because the background-image property holds the PNG */}
          </div>
        ...
        <div className="flex justify-center gap-8 mt-12 text-2xl md:text-3xl">
          <a href="#" className="hover:text-blue-400 transition-all hover:scale-110"><FaXTwitter /></a>
